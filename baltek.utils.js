...
///////////////////////////////////////////////////////////////////////////////
baltek.utils = { };
baltek.utils.$initPackageCalled = false;

baltek.utils.$initPackage = function(){

    if ( baltek.utils.$initPackageCalled ) return;
    baltek.utils.$initPackageCalled = true;

    // Init required packages
    baltek.debug.$initPackage();

    // Init inner classes
    baltek.utils.Observable.$initClass();
}
...
baltek.utils.Observable.$initClassCalled = false;

baltek.utils.Observable.$initClass = function(){

    if ( baltek.utils.Observable.$initClassCalled ) return;
    baltek.utils.Observable.$initClassCalled = true;

    baltek.utils.inherit(baltek.utils.Observable, Object);

    baltek.utils.Observable.prototype.$initObject = function(){
        this.aspectNames = [];
