...
baltek_the_rules_package_html_path = os.path.join(baltek_the_program_package_path, "html")
...
for file_path in file_paths:
    ...
    for line in file_lines:
        ...
        if license_html_begin_match:
            ...
            assert os.path.dirname(os.path.dirname(file_path)) == baltek_the_rules_package_html_path
