...
Baltek.View.Element.prototype.init = function(id){
    ...
    Baltek.View.I18n.addListener(listner);
}
...
Baltek.View.Button.prototype.changeI18n = function(){
    this.element.innerHTML = Baltek.View.I18n.getText( this.i18nKeyPrefix + "_button" );
}

Baltek.View.Button.prototype.init = function(id){
    Baltek.View.FilerButton.super.init.call(this,id);

    // Finalize the construction regarding I18n.
    this.changeI18n();
}
//----------------------------------------------------------------------------
Baltek.View.FilerButton = function(id){
    this.init(id);
};

Baltek.Utils.inheritPrototype(Baltek.View.FilerButton, Baltek.View.Element)

Baltek.View.FilerButton.prototype.changeI18n = function(){
    this.element.innerHTML = Baltek.View.I18n.getText( this.i18nKeyPrefix + "_button" );
    this.file = Baltek.View.I18n.getText( this.i18nKeyPrefix + "_file" );
}

Baltek.View.FilerButton.prototype.init = function(id){
    Baltek.View.FilerButton.super.init.call(this,id);
...
Baltek.View.FilerButton.prototype.openWindow = function(){
...
Baltek.View.Selector.prototype.changeI18n = function(){
    ...
    for (i=0; i < n ; i++) {
        ...
        var text = Baltek.View.I18n.getText( this.i18nKeyPrefix + "_" + value );
...
///////////////////////////////////////////////////////////////////////////////
Baltek.View.ButtonZone.Language = { initCalled: false };

Baltek.View.ButtonZone.Language.change = function(){
    Baltek.View.I18n.setLanguage(Baltek.View.ButtonZone.Language.selector.value);
}

Baltek.View.ButtonZone.Language.createSelectorOptions = function(){
    Baltek.View.ButtonZone.Language.selector.innerHTML = "" ;

    var n = Baltek.View.I18n.availableLanguages.length;
    var i = 0;
    for (i=0; i < n ; i++) {
        var languageCode = Baltek.View.I18n.availableLanguages[i];
        var languageName = Baltek.View.I18n.translations[languageCode]["Baltek_ButtonZone_Language_name"];

        Baltek.View.ButtonZone.Language.selector.innerHTML +=
            "<option value=" + "\"" +  languageCode + "\"" + ">" + languageName + "</option>" ;
    }

    Baltek.View.ButtonZone.Language.selector.value = Baltek.View.I18n.getLanguage();
}

Baltek.View.ButtonZone.Language.init = function(){
    if ( ! Baltek.View.ButtonZone.Language.initCalled ) {
        Baltek.View.ButtonZone.Language.initCalled = true;

        Baltek.View.ButtonZone.Language.selector = document.getElementById( "Baltek_ButtonZone_Language" );
        Baltek.View.ButtonZone.Language.createSelectorOptions();
    }
}
///////////////////////////////////////////////////////////////////////////////
