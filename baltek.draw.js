...
///////////////////////////////////////////////////////////////////////////////
baltek.draw = { };
baltek.draw.$initPackageCalled = false;

baltek.draw.$initPackage = function(){

    if ( baltek.draw.$initPackageCalled ) return;
    baltek.draw.$initPackageCalled = true;

    // Init required packages
    baltek.debug.$initPackage();
    baltek.style.$initPackage();

    // Init inner classes
    baltek.draw.Ball.$initClass();
    baltek.draw.Box.$initClass();
    baltek.draw.Circle.$initClass();
...
baltek.draw.Box = function(ix, iy, xyLabel){
    this.$initObject(ix, iy, xyLabel);
}

baltek.draw.Box.$initClassCalled = false;

baltek.draw.Box.$initClass = function(){

    if ( baltek.draw.Box.$initClassCalled ) return;
    baltek.draw.Box.$initClassCalled = true;

    baltek.utils.inherit(baltek.draw.Box, baltek.draw.Selectable);

    baltek.draw.Box.prototype.$initObject = function(ix, iy, xyLabel){
        baltek.draw.Box.super.$initObject.call(this);
...
baltek.draw.Circle.$initClassCalled = false;

baltek.draw.Circle.$initClass = function(){

    if ( baltek.draw.Circle.$initClassCalled ) return;
    baltek.draw.Circle.$initClassCalled = true;

    baltek.utils.inherit(baltek.draw.Circle, baltek.draw.Selectable);

    baltek.draw.Circle.prototype.$initObject = function(){
        baltek.draw.Circle.super.$initObject.call(this);
...
baltek.draw.Footballer.$initClassCalled = false;

baltek.draw.Footballer.$initClass = function(){

    if ( baltek.draw.Footballer.$initClassCalled ) return;
    baltek.draw.Footballer.$initClassCalled = true;

    baltek.utils.inherit(baltek.draw.Footballer, baltek.draw.Circle);

    baltek.draw.Footballer.prototype.$initObject = function(teamIndex, force){
        baltek.draw.Footballer.super.$initObject.call(this);
