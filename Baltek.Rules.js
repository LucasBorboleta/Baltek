...
///////////////////////////////////////////////////////////////////////////////
baltek.rules = { };
baltek.rules.$initPackageCalled = false;

baltek.rules.$initPackage = function(){

    if ( baltek.rules.$initPackageCalled ) return
    baltek.rules.$initPackageCalled = true;
    ...
    // Init inner classes
    baltek.rules.Ball.$initClass();
    baltek.rules.Box.$initClass();
    baltek.rules.Engine.$initClass();
    baltek.rules.Field.$initClass();
    baltek.rules.Footballer.$initClass();
    baltek.rules.Team.$initClass();
}
///////////////////////////////////////////////////////////////////////////////
...
baltek.rules.Ball.$initClassCalled = false;

baltek.rules.Ball.$initClass = function(){

    if ( baltek.rules.Ball.$initClassCalled ) return;
    baltek.rules.Ball.$initClassCalled = true;

    baltek.utils.inherit(baltek.rules.Ball, Object);

    baltek.rules.Ball.prototype.$initObject = function(){
        this.box = null;
    }
}
///////////////////////////////////////////////////////////////////////////////
baltek.rules.Box = function(engine, ix, iy){
    this.$initObject(engine, ix, iy);
};

baltek.rules.Box.$initClassCalled = false;

baltek.rules.Box.$initClass = function(){

    if ( baltek.rules.Box.$initClassCalled ) return;
    baltek.rules.Box.$initClassCalled = true;

    baltek.utils.inherit(baltek.rules.Box, Object);

    baltek.rules.Box.prototype.$initObject = function(engine, ix, iy){
        this.engine = engine;
        this.ix = ix ;
        this.iy = iy ;
...
baltek.rules.Engine.$initClassCalled = false;

baltek.rules.Engine.$initClass = function(){

    if ( baltek.rules.Engine.$initClassCalled ) return;
    baltek.rules.Engine.$initClassCalled = true;

    baltek.utils.inherit(baltek.rules.Engine, baltek.utils.Observable);

    baltek.rules.Engine.prototype.$initObject = function(){
        this.SCORE_MAX = 2;
        this.CREDIT_MAX = 3;
...
baltek.rules.Field = function(engine){
    this.$initObject(engine);
};

baltek.rules.Field.$initClassCalled = false;

baltek.rules.Field.$initClass = function(){

    if ( baltek.rules.Field.$initClassCalled ) return;
    baltek.rules.Field.$initClassCalled = true;

    baltek.utils.inherit(baltek.rules.Field, Object);

    baltek.rules.Field.prototype.$initObject = function(engine){
        this.engine = engine;
...
baltek.rules.Footballer = function(team, force){
    this.$initObject(team, force);
};

baltek.rules.Footballer.$initClassCalled = false;

baltek.rules.Footballer.$initClass = function(){

    if ( baltek.rules.Footballer.$initClassCalled ) return;
    baltek.rules.Footballer.$initClassCalled = true;

    baltek.utils.inherit(baltek.rules.Footballer, Object);

    baltek.rules.Footballer.prototype.$initObject = function(team, force){
        this.team = team;
        this.force = force;
        this.box = null;
        this.canKick = false;
...
baltek.rules.Team = function(teamIndex){
    this.$initObject(teamIndex);
};

baltek.rules.Team.$initClassCalled = false;

baltek.rules.Team.$initClass = function(){

    if ( baltek.rules.Team.$initClassCalled ) return;
    baltek.rules.Team.$initClassCalled = true;

    baltek.utils.inherit(baltek.rules.Team, Object);

    baltek.rules.Team.prototype.$initObject = function(teamIndex){
